...
export default class HomeComponent extends Component {
  ...
  renderCell({ item }) {
    return (
      ...
      <TouchableOpacity style={styles.rowViewContainer} onPress={() => this.props.navigation.navigate('UserDetailsContainer', { selectedUserData: item })}>
